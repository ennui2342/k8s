...
- `monitoring/grafana` — Grafana admin credentials (auto-generated by Helm; retrieve with `kubectl get secret grafana -n monitoring -o jsonpath='{.data.admin-password}' | base64 -d`)
